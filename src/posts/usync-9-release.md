---
title: uSync v9 and uSync.Complete v9 are out 🎈
...
### Domain License
Domain licenses cover your use of uSync.Complete for a single project; for uSync.Complete v9 a domain licence is  £950 *(+vat where applicable)* - this is a £50 increase on the uSync.Complete price for v8.

<p class="text-center">
<a href="https://jumoo.co.uk/usync/complete" class="btn btn-success btn-lg">Get uSync.Complete</a>
</p>

*if you want to upgrade from v8 to a v9 licence the upgrade cost is £350.*
